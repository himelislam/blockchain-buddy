    ...
    return (
        <div className='grid grid-cols-2 pl-[100px] pr-[100px] items-center my-10'>
            <div className='text-left'>
                ...
                <button className='btn rounded p-3 font-thin text-white mt-6  transition ease-in-out delay-150 bg-slate-500 hover:-translate-y-1 hover:scale-110 hover:bg-gray-700 duration-300' href='https://www.g2.com/products/ethereum/reviews#details'>Read More</button>
            </div>
            <div>
